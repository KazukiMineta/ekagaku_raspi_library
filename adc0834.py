...
#------------------------------------------------------------------------------------------#
### File name	:	adc0834.py
### Version		:	ver.0.2
### Created by	:	e-kagaku Supporter, Kazuki Mineta

### Purpose		:	This file is a library for the ADC0834, which is used to read analog sensors.
### Datasheet 	:	https://www.ti.com/lit/ds/symlink/adc0831-n.pdf
#------------------------------------------------------------------------------------------#
...
#------------------------------------------------------------------------------------------#
### Update history:
# 2025/08/19    ver.0.1     Added ADC0834.py
# 2026/02/17	ver.0.2		Renamed adc0834.py
#------------------------------------------------------------------------------------------#